"""
Django settings for diabeties_predicition project.
...
SECRET_KEY = 'django-insecure-_buzn4bxbz8w-we8*9mump=r&(o6mx!0%nt=0z^&fgdku5@bkr'
...
WSGI_APPLICATION = 'diabeties_predicition.wsgi.application'
